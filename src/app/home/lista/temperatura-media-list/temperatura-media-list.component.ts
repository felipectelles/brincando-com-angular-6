    ...
    prepareTemperaturaMedia(response){
        ...
        response.forEach(element => {
            ...
            temperaturaMedia.temperaturaMediaMensal.push({
                mes: 'Jan',
                media: +(totalJaneiro/janeiro.length).toFixed(1)
            });
            ...
            temperaturaMedia.temperaturaMediaMensal.push({
                mes: 'Fev',
                media: +(totalFevereiro/fevereiro.length).toFixed(1)
            });
            ...
            temperaturaMedia.temperaturaMediaMensal.push({
                mes: 'Mar',
                media: +(totalMarco/marco.length).toFixed(1)
            });
            ...
            temperaturaMedia.temperaturaMediaMensal.push({
                mes: 'Abr',
                media: +(totalAbril/abril.length).toFixed(1)
            });
            ...
            temperaturaMedia.temperaturaMediaMensal.push({
                mes: 'Mai',
                media: +(totalMaio/maio.length).toFixed(1)
            });
            ...
            temperaturaMedia.temperaturaMediaMensal.push({
                mes: 'Jun',
                media: +(totalJunho/junho.length).toFixed(1)
            });
            ...
            temperaturaMedia.temperaturaMediaMensal.push({
                mes: 'Jul',
                media: +(totalJulho/julho.length).toFixed(1)
            });
            ...
            temperaturaMedia.temperaturaMediaMensal.push({
                mes: 'Ago',
                media: +(totalAgosto/agosto.length).toFixed(1)
            });
            ...
            temperaturaMedia.temperaturaMediaMensal.push({
                mes: 'Set',
                media: +(totalSetembro/setembro.length).toFixed(1)
            });
            ...
            temperaturaMedia.temperaturaMediaMensal.push({
                mes: 'Out',
                media: +(totalOutubro/outubro.length).toFixed(1)
            });
            ...
            temperaturaMedia.temperaturaMediaMensal.push({
                mes: 'Nov',
                media: +(totalNovembro/novembro.length).toFixed(1),
            });
            ...
            temperaturaMedia.temperaturaMediaMensal.push({
                mes: 'Dez',
                media: +(totalDezembro/dezembro.length).toFixed(1)
            });
